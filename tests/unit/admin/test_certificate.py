...
def test_assignment_request_invalid() -> None:
    """Tests the CertificateAssignmentRequest custom validator works as expected"""
...
@pytest.mark.parametrize(
    ...
    [
        ("ARST123456" * 4, 1, dt.datetime(1985, 9, 30, 0, 0, 0)),
        ("ARST123456" * 4, 2, None),
