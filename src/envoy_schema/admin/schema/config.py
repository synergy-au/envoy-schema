...
class RuntimeServerConfigRequest(BaseModel):
    ...
    tp_pollrate_seconds: Optional[int] = None  # If set - update the TariffProfile pollRate
    tti_pollrate_seconds: Optional[int] = None  # If set - update the TimeTariffInterval pollRate
